  ...
  useEffect(() => {
    async function fetchProfile() {
      try {
        ...
        const username = sessionRes.data.user.username;
  ...
  return (
    <div className="w-full max-w-[728px] mx-auto pt-12 pb-12 flex flex-col gap-8">
      <ProfileHeader
        ...
        followingCount={user.followingCount} isOwnProfile={false} username={null}      />
              ...
              <div key={article.id} className="relative">
                ...
                <div className={article.statusId === 2 ? "pt-4" : ""}>
                  <ProfileArticleCard
                    ...
                    onDelete={handleDelete} isOwnProfile={false}                  />
                </div>
              </div>
            ))
          )}
